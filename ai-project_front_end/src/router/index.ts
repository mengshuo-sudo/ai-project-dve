...
import EnvironmentsPanel from '@/components/figma/ai-testing-platform/EnvironmentsPanel.vue'
import MembersPanel from '@/components/figma/ai-testing-platform/MembersPanel.vue'
import RolePermissionsPanel from '@/components/figma/ai-testing-platform/RolePermissionsPanel.vue'
import AuditLogsPanel from '@/components/figma/ai-testing-platform/AuditLogsPanel.vue'
import IntegrationsPanel from '@/components/figma/ai-testing-platform/IntegrationsPanel.vue'
...
const ProjectEnvironments = createProjectShellPage('', EnvironmentsPanel)
const ProjectMembers = createProjectShellPage('', MembersPanel)
const ProjectRolePermissions = createProjectShellPage('', RolePermissionsPanel)
const ProjectAuditLogs = createProjectShellPage('', AuditLogsPanel)
const ProjectIntegrations = createProjectShellPage('', IntegrationsPanel)
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: ProjectRolePermissions
    },
    {
      path: '/projects/:projectId/settings/audit',
      component: ProjectAuditLogs
    },
    {
    ...
    {
      path: '/settings/rbac',
      redirect: '/projects/1/settings/members'
    },
    {
      path: '/settings/audit',
      redirect: '/projects/1/settings/audit'
    },
    {
      path: '/dashboard',
